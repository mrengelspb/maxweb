...
function Login({
  ...
  const SubmitHandler = async (ev) => {
    if (ev.type === 'click' || ev.key === 'Enter' && ev.type === 'keydown') {
    ...
    <main className="login">
      <form className="login--form">
        ...
        <div className="login--wrapperInput">
          ...
          <input className="login--input" ref={passwordRef} onKeyDown={handlerKeyDownButton} type="password" value={password} onChange={handlerPassword} />
        </div>
